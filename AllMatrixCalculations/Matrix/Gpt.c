...
int main() {
    int rows1 = 0, cols1 = 0, i, j, rows2 = 0, cols2 = 0;
    int CalChoice;
    char choice;
    ...
    do {
        ...
        switch (CalChoice) {
            ...
            case 7:
                if (counter == 0) {
                    result = (double *)malloc(rows1 * cols2 * sizeof(double));
                }
                if (counter != 0) {
                ...
                EE204_4_Multiplication(Matrix1, Matrix2, result);
        ...
        counter++;
        printf("Do you want to make new calculation (Y / N):\n");
        scanf(" %c", &choice);
